...
//from here: https://github.com/uhs3939/SkyStone/blob/master/TeamCode/src/main/java/org/firstinspires/ftc/teamcode/opencvSkystoneDetector.java

@Autonomous(name= "SkystoneDetectorSample", group="Sky autonomous")
@Disabled//comment out this line before using
public class SkystoneDetectorSample extends LinearOpMode {
    ...
    public void runOpMode() throws InterruptedException {
       ...
       // phoneCam = OpenCvCameraFactory.getInstance().createInternalCamera(OpenCvInternalCamera.CameraDirection.BACK, cameraMonitorViewId);
        ...
        SplitAveragePipeline splitAveragePipeline = new SplitAveragePipeline();
        phoneCam.setPipeline(splitAveragePipeline);
